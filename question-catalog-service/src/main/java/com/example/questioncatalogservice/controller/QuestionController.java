...
public class QuestionController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<Question> patchQuestion(@PathVariable Long id, @RequestBody Question question) {
        Question patchedQuestion = questionService.patchQuestion(id, question);
